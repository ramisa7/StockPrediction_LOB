...
| ------------- | ------------- |
|Dataset: Normalized version of F-1 2010 | Dataset: Historical Stock Price( Yahoo API)   |
Convolutional Filter (CNN) |
| ------------- | ------------- |
...
Dataset: Normalized version of F-1 2010 
Convolutional Filter (CNN) 



Dataset: Historical Stock Price( Yahoo API) 
